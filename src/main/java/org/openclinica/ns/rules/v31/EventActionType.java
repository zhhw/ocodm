    ...
    implements Serializable
{
    ...
    public boolean isSetRunOnStatus() {
        return (this.runOnStatus!= null);
    }
    ...
    public boolean isSetEventDestination() {
        return ((this.eventDestination!= null)&&(!this.eventDestination.isEmpty()));
    }

    public void unsetEventDestination() {
