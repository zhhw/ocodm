    ...
    implements Serializable
{
    ...
    protected List<Serializable> studyEventDataElementExtension;
     ...
     * 
     */
    public List<Serializable> getStudyEventDataElementExtension() {
        if (studyEventDataElementExtension == null) {
            studyEventDataElementExtension = new ArrayList<Serializable>();
        }
        return this.studyEventDataElementExtension;
    }

    public boolean isSetStudyEventDataElementExtension() {
        return ((this.studyEventDataElementExtension!= null)&&(!this.studyEventDataElementExtension.isEmpty()));
    }

    public void unsetStudyEventDataElementExtension() {
        this.studyEventDataElementExtension = null;
    }
