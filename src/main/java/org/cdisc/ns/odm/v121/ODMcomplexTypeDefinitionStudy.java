    ...
    implements Serializable
{
    ...
    public boolean isSetGlobalVariables() {
        return (this.globalVariables!= null);
    }
    ...
    public boolean isSetBasicDefinitions() {
        return (this.basicDefinitions!= null);
    }
    ...
    public boolean isSetMetaDataVersion() {
        return ((this.metaDataVersion!= null)&&(!this.metaDataVersion.isEmpty()));
    }
